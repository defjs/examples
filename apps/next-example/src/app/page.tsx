...
import { useGetUser } from '@/lib/api/v1/user'
import { createGlobalClient, isHttpResponseError } from '@defjs/core'
...
export default function Home() {
  let { doRequest, inputValue } = useGetUser()

  useEffect(() => {
    const abort = new AbortController()
    inputValue = 1
    doRequest(inputValue, { abort: abort.signal })
